...
if menu == "📊 채용 및 컴플라이언스":
    # 폰트 사이즈 조정 및 텍스트 수정 적용
    st.markdown("<div class='b2c-page-title' style='font-size: 32px;'>인사 컴플라이언스 및 채용 대시보드</div>", unsafe_allow_html=True)
    st.markdown("<p class='b2c-page-subtitle'>기업 구인 요건에 부합하는 우수 외국인 인재를 추천하고, 채용 가능 쿼터를 실시간으로 모니터링합니다.</p>", unsafe_allow_html=True)
    
    # 폰트 사이즈 24px로 확대 및 (Direct Sourcing) 삭제
    st.markdown("<div class='b2c-section-title' style='color:#2563EB; font-size: 24px;'>🎯 맞춤형 우수 외국인 인재 추천</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='b2c-section-title' style='font-size: 18px;'>인사 컴플라이언스 모니터링</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='b2c-section-title' style='margin-top: 16px; font-size: 18px;'>👥 소속 외국인 인력 체류 만료 현황</div>", unsafe_allow_html=True)
...
# 화면 2: 지원자 비자 평가
    ...
    st.markdown("<div class='b2c-page-title' style='font-size: 28px;'>지원자 비자 적격성 & 실무 역량 평가</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='b2c-section-divider'></div>", unsafe_allow_html=True)
    st.markdown("<div class='b2c-section-title' style='font-size: 18px;'>정밀 요건 분석</div>", unsafe_allow_html=True)
...
# 화면 3: 비자 행정 & AI 서류
    ...
    st.markdown("<div class='b2c-page-title' style='font-size: 28px;'>비자 행정 트래커 및 AI 서류 자동 생성</div>", unsafe_allow_html=True)
    st.markdown("<p class='b2c-page-subtitle'>비자 사증 발급까지의 전 과정을 구직자와 양방향으로 공유하며, 핵심 서류를 AI로 즉시 작성합니다.</p>", unsafe_allow_html=True)
    
    st.markdown("<div class='b2c-section-title' style='font-size: 18px;'>서류 준비 진척도</div>", unsafe_allow_html=True)
    ...
    st.write("")
    st.markdown("<div class='b2c-section-divider'></div>", unsafe_allow_html=True)
    st.markdown("<div class='b2c-section-title' style='color:#2563EB; font-size: 18px;'>✨ AI E-7 고용사유서 자동 생성 엔진</div>", unsafe_allow_html=True)
